        ...
        <>
            <div className="statistic-container">
                ...
                <div className="statistic-content">
                    <h1 className='statistic-content-Heading' style={{color:'black'}}>Connecting Cricketers and Coaches</h1>
                    <p className='statistic-content-para' style={{color:'black'}}>
                    ...
                    <div className="statistic-stats" style={{color:'black'}}>
                        <div>
